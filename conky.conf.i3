...
conky.text = [[
  ...
  ${voffset -3}${color green}Networking:
   ...
   ${voffset 6}${color efefef}D:${totaldown wlp2s0}${goto 100}${downspeed wlp2s0}${goto 170}U:${totalup wlp2s0}${goto 270}${upspeed wlp2s0}
  ${color 000000}${downspeedgraph wlp2s0 20,150 ff9999 ff0000 }${color 000000}${upspeedgraph wlp2s0 20,150 ff9999 ff0000 }
  ...
  ${voffset 2}${color green}File systems: 
   ${color green}/${goto 100}${color efefef}[ ${fs_used /} / ${color efefef}${fs_size /} ]${goto 250}${color red}${fs_bar 5 /}
